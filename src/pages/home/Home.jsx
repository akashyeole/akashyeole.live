...
const Home = ({ key }) => {
  ...
  useEffect(() => {
    const themeColor =
      document.documentElement.style.getPropertyValue("--first-color");
      ...
      <div className="home__content">
        <div className="home__data">
          ...
          <p className="home__description">
            As a software developer, I am deeply invested in creating clean and
            intuitive experiences for users. I am driven by my commitment to
            building software that simplifies complex processes and tasks.
          </p>
